    ...
    <div class="row">
        ...
        <div id="main-content" class="span10">
            ...
            <p class="align-justify">
               ...
               <?php $get_rating=App::getRepository('Talk')->getRating($talk['talk_id']);
                      $total_rating=$get_rating['total_comments']%5;
                        for($i=0;$i<$total_rating;$i++)
                       {
                           echo "<img src='http://icons.iconarchive.com/icons/oxygen-icons.org/oxygen/256/Actions-rating-icon.png' width='10' height='10'/>";
                           echo '&nbsp;';
                       }?>
            </p>
